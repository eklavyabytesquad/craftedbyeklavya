        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div 
                key={index}
                className="bg-purple-900/30 backdrop-blur-sm rounded-xl border border-purple-500/30 p-6 shadow-lg transition-all duration-300 hover:shadow-purple-500/20"
              >
                <div className="mb-4">
                  {feature.icon}
                </div>
                <h3 className="text-xl font-semibold text-amber-300 mb-3">{feature.title}</h3>
