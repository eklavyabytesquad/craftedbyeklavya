...
export default function StudentSubmissions() {
  ...
  const renderSubmissionCard = (submission) => {
    return (
      <div key={submission.id} className="bg-white shadow-md rounded-lg overflow-hidden transition-all duration-300 hover:shadow-lg border border-gray-200">
          ...
          <div className="mt-3 grid grid-cols-2 gap-2">
            {submission.image_data && (
              <div className="col-span-1">
                <button 
                  onClick={() => window.open(submission.image_data, '_blank')}
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg overflow-hidden">
      <div className="bg-blue-600 px-6 py-4">
        ...
        {profile && (
          <p className="text-white text-sm mt-1">{profile.name || 'Unnamed Student'}</p>
        )}
      </div>
      ...
      <div className="p-6">
        ...
        {authLoading || loading ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="mt-4 text-lg font-medium text-gray-700">No submissions yet</h3>
            <p className="mt-1 text-gray-500">
              You haven't submitted any assignments. Go to the submit form to add your first assignment.
            </p>
          </div>
        ) : (
